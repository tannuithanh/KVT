...
<body>
    ...
    <header id="header" class="header fixed-top d-flex align-items-center" style="background-color: #00529C;color: white !important; font-family:Arial, Helvetica, sans-serif">
        ...
        <div class="d-flex align-items-center justify-content-between">
            <a href="{{ route('trangChu') }}" class="logo d-flex align-items-center justify-content-center" style="text-align: center; border-radius: 30px; background-color: white; padding: 5px;">
    ...
    @php
        ...
        $isActiveDashboard = $currentRoute == 'trangChu';
